...
- **[Terraform Local Demo](https://github.com/mariano-tp/terraform-local-demo/blob/main/README.ES.md)** - Infraestructura reproducible sin proveedores cloud (`local` + `random`). CI con `fmt` y `validate`.  
...
- **[AWS Serverless Local Demo](https://github.com/mariano-tp/aws-serverless-local-demo/blob/main/README.ES.md)** - Serverless “sin cloud”: S3 + SQS + DynamoDB sobre LocalStack, con tests de integración y CI en GitHub Actions.  
...
### Kubernetes & Delivery
- **[Helm Chart Skeleton](https://github.com/mariano-tp/helm-chart-skeleton/blob/main/README.ES.md)** - Esqueleto de Helm Chart para despliegues en Kubernetes, con CI (lint + template) y releases automatizados.  
...
- **[Kubernetes Admin Ops Kit](https://github.com/mariano-tp/k8s-admin-ops-kit/blob/main/README.ES.md)** - Runbooks-as-code para administradores de Kubernetes: playbooks Ansible (cordon/drain, reinicios ordenados, rollback), Helm Chart (api/worker/nlp con probes, PDB, NetworkPolicy) y CI con KinD.  
...
### Observabilidad
- **[FastAPI Observability Demo](https://github.com/mariano-tp/fastapi-observability-demo/blob/main/README.ES.md)** - Servicio FastAPI con `/metrics`, tests y CI (pytest + build de Docker).  
...
- **[GitHub Observability Demo](https://github.com/mariano-tp/github-observability-demo/blob/main/README.ES.md)** - Stack de Prometheus + Grafana + exporter para métricas de GitHub.  
...
### MLOps
- **[ML Mini Pipeline](https://github.com/mariano-tp/ml-mini-pipeline/blob/main/README.ES.md)** - Mini pipeline de ML (scikit-learn) que genera datos sintéticos, entrena y publica artefactos (`model.pkl`, `metrics.json`) con CI.  
...
- **[MLflow Mini Experiments](https://github.com/mariano-tp/mlflow-mini-experiments/blob/main/README.ES.md)** - Tracking de experimentos con MLflow: parámetros, métricas y modelos; CI reproducible; UI local opcional con Docker Compose.  
